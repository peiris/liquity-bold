...
contract BorrowerOperations is LiquityBase, AddRemoveManagers, Ownable, IBorrowerOperations {
    ...
    */
    ...
    function _openTrove(
        ...
        vars.avgInterestRate = vars.contractsCache.activePool.getNewApproxAvgInterestRateFromTroveChange(_troveChange);
    ...
    */
    ...
    function setInterestBatchManager(
        ...
        _requireNewInterestBatchManager(vars.oldBatchManager, _newBatchManager);
        ...
        if (isTroveInBatch) {
            vars.oldBatch = vars.troveManager.getLatestBatchData(vars.oldBatchManager);
            ...
            vars.activePool.mintBatchManagementFeeAndAccountForChange(
