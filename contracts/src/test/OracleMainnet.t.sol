...
contract OraclesMainnet is TestAccounts {
    ...
    function setUp() public {
        ...
        externalAddresses.OsTokenVaultController = 0x2A261e60FB14586B474C208b1B7AC6D0f5000306;
    ...
    function testOpenTroveWETH() public {
        ...
        vm.startPrank(A);
        contractsArray[0].borrowerOperations.openTrove(A, 0, coll, debtRequest, 0, 0, 0, 0, address(0), address(0), address(0));
    ...
    function testOpenTroveRETH() public {
        ...
        vm.startPrank(A);
        contractsArray[1].borrowerOperations.openTrove(A, 0, coll, debtRequest, 0, 0, 0, 0, address(0), address(0), address(0));
    ...
    function testOpenTroveETHX() public {
        ...
        vm.startPrank(A);
        contractsArray[3].borrowerOperations.openTrove(A, 0, coll, debtRequest, 0, 0, 0, 0, address(0), address(0), address(0));
    ...
    function testOpenTroveOSETH() public {
        ...
        vm.startPrank(A);
        contractsArray[4].borrowerOperations.openTrove(A, 0, coll, debtRequest, 0, 0, 0, 0, address(0), address(0), address(0));
    ...
    function testOpenTroveWSTETH() public {
        ...
        vm.startPrank(A);
        contractsArray[2].borrowerOperations.openTrove(A, 0, coll, debtRequest, 0, 0, 0, 0, address(0), address(0), address(0));
